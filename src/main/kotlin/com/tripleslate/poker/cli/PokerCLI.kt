package com.tripleslate.poker.cli
...
import com.tripleslate.poker.HandEquityCalculator
import com.tripleslate.poker.MonteCarloEquityCalculator
...
class PokerCLI : CliktCommand(name = "Poker Equity Calculator") {
    ...
    override fun run() {
        ...
        while (true) {
            ...
            when {
                ...
                input == "q" -> {
                    echo("Exiting...")
                    MultiplatformSystem.exitProcess(0)
                }
    ...
    private fun calculateEquityWithProgress(calculator: HandEquityCalculator): Float {
        ...
        val listener = MonteCarloEquityCalculator.ProgressListener { progress, total ->
